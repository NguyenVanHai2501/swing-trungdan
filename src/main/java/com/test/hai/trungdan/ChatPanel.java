...
public class ChatPanel extends javax.swing.JPanel {
    ...
    public ChatPanel() {
        ...
        ImageIcon icon = new ImageIcon("src/main/java/com/test/hai/trungdan/image/chat.png");

        icon.setImage(icon.getImage().getScaledInstance(80, 80, java.awt.Image.SCALE_DEFAULT));
    ...
    private void initComponents() {
        ...
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Chat 1", "Chat 2", "Chat 3", "Chat 4", "Chat 5" };
        ...
        jLabel3.setText("Message 1");

        jLabel4.setText("Message 2");
